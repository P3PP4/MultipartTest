package com.multipart.test.global.util;
...
public class ImageProcess {
	 ...
	 */
//	@Transactional
	public MultipartFile resizeImage (MultipartFile multipartFile, int targetWidth) throws IOException, ImageProcessingException, MetadataException {
